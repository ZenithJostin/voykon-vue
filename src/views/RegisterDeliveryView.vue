          ...
          <form @submit.prevent="submitForm" class="form login">
            ...
            <div class="form-two-columns">
              <div class="form-field">
                ...
                <input id="nombre" type="text" name="nombre" class="form-input" placeholder="Nombre/s" required
                  v-model="nombres" />
              </div>
              <div class="form-field">
                <label for="apellido"><span class="material-symbols-outlined"> person </span></label>
                <input id="apellido" type="text" name="nombre" class="form-input" placeholder="Apellido/s" required
                  v-model="apellidos" />
              </div>
            </div>
...
const submitForm = async () => {
  if (!passwordMismatch.value) {
    try {
      ...
      formData.append('names', nombres.value);
      formData.append('lastnames', apellidos.value);
      ...
      const response = await axios.post(`${apiBaseUrl}/api/deliveryman/register`, formData, {
        headers: {
