          ...
          <form action="#">
            ...
            <div class="form-mid-container">
              ...
              <div class="form-field profile-lastname">
                ...
                <input class="info-field" type="text" id="user-lastname" :value="user.user_lastname"
              ...
              <div class="form-field profile-description">
                ...
                <textarea class="info-field" name="user-description" id="user-description"
                  :value="user.user_description" :disabled="fieldActive"></textarea>
              </div>
            </div>
            <div class="form-bottom-container">
              ...
              <button @click="activateBtn" type="button" :class="`cancel-button  ${isInactive}`">
                Cancelar
              </button>
